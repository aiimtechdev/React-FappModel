    ...
    <Row className="ms-0 me-0">
      ...
      <Col xs="6" className="pe-1 ps-1">
        <ul className="list-unstyled">
          <li>
            <Link to="/my-profile">
              <CsLineIcons icon="gear" className="me-2" size="17" /> <span className="align-middle">Profile</span>
            </Link>
          </li>
          <li>
...
const NavUserMenuDropdownToggle = React.memo(
  React.forwardRef(({ onClick, expanded = false, user = {} }, ref) => (
    ...
    >
      <img className="profile" alt={user.firstName + ' ' + user.lastName} src={user.thumb ? `data:image/png;base64,${user.thumb}` : '/img/profile.webp'} />
