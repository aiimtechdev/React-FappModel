...
const PerformanceChart = (props) => {
      ...
      datasets: [
        {
          ...
          backgroundColor: themeValues.success,
          data: [],
        },
        {
          ...
          backgroundColor: themeValues.danger,
          data: [],
        },
      ],
    };
  ...
  useEffect(() => {
    ...
    myChart.data.labels = props.label;
    props.label.forEach((dataset, index) => {
      let actDvceStatFil = props.activeDeviceStat.filter(e => e.date === dataset);
      let criDvceStatFil = props.crticalDeviceStat.filter(e => e.date === dataset);
      if(actDvceStatFil[0] && actDvceStatFil.length != 0) {
        myChart.data.datasets[0].data[index] = actDvceStatFil[0]['count'];
      }
      if(criDvceStatFil[0] && criDvceStatFil.length != 0) {
        myChart.data.datasets[1].data[index] = criDvceStatFil[0]['count'];
      }
    });
    myChart.update();
    return () => {
