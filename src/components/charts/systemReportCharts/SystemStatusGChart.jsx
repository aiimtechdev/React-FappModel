...
const SystemStatusGChart = ({ value }) => {
    ...
    return (
        <div className='d-flex h-100'>
            <div style={{ flex: '0.7', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                <div style={{ textTransform: 'uppercase' }}>System Status</div>
            </div>
            <div style={{ flex: '0.3' }}>
                <GaugeChart id="sysStatus" style={{ width: '160px', height: '100%', fill: 'black' }}
                    nrOfLevels={2}
                    animate={false}
...
export default SystemStatusGChart;
